...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Retrieve Candidate Password</title>
	...
	<body>
		...
		<div>
			...
			<div id="bodycontainer">
				...
				<div id="formheader">	
					<form method="post" action="forgotPasswordCandidate.action" id="forgotpasswordcandidateform">	
								<div class="formunit">EmailId</div>
					        	<input type="email" id="emailId" name="candidate.emailId" required autofocus>	<br>
